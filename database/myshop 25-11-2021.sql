...
(10, 'ATX CASE (NP) VIKINGS A3 (BLACK)', 'รองรับเมนบอร์ด : ATX, Micro ATX, Mini ITX ', 'CASE', '570', 'VIKINGS', 'https://img.advice.co.th/images_nas/pic_product4/A0131519/A0131519OK_BIG_1.jpg', '1', '46', 0, 0, '2021-11-23 19:47:32', '2021-11-23 19:47:32'),
...
(0, 'admin', '1234', 'แอดมินไอตู่', '0987654320', '99999999', 'admin@gmail.com', '555/656', 'models/images/1637729450.png', '2021-11-23 03:45:01', '2021-11-24 11:50:50', 'Admin'),
...
(7, 'ประยุกธ์', '1234', 'ประยุทธ์ จันทร์โอชา', '0982452523', '0', 'gg@gmail.com', '88/88', 'https://virl.bc.ca/wp-content/uploads/2019/01/AccountIcon2.png', '2021-11-24 20:00:03', '2021-11-24 20:35:43', 'member'),
...
--
ALTER TABLE `tbl_users`
  MODIFY `user_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID ผู้ใช้', AUTO_INCREMENT=9;
COMMIT;
