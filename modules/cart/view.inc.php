<div class="col-md-12 bg-secondary p-5 row">
    <div class="col-md-8 bg-body rounded-left p-5 border border-dark">
        <div>
                        ...
                        <tr id="tr_<?php echo $data[$i]['product_id']?>">
                            ...
                            <td>
                                ...
                                <div>
                                    ...
                                    <a class="btn btn-success mt-2 w-100" href="#">
                                        สั่งซื้อ
                                    </a>
                                </div>
                            </td>
    ...
    <div class="col-md-4 bg-body rounded-right p-5 border border-dark" style="height: fit-content;">
        <div>
            ...
            <div class="btn btn-outline-success w-100 mt-2" onclick="openBill()" data-bs-toggle="modal" data-bs-target="#myModal">
                สั่งซื้อทันที
            </div>
        </div>
    </div>
  ...
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      ...
      <div class="modal-body">
            ...
            <div>
                <p>เงินในบัญชี : <?php echo number_format($_SESSION['user_data']['user_money'])."฿"?></p>
...
function openBill() {
    ...
    for (let i = 0; i < product_lists_arr.length; i++) {
        if (product_lists_arr[i].checked) {
            ...
            table_str += '<tr id="'+product_id.value+'" class="bill_row">'+
                ...
                '</td>'+
                '<td>'+
                    '<img style="width:25vh;" src="'+product_img.getAttribute("src")+'">'+
    ...
    if((price_total.value <= user_money) && (tick > 0)){
