<div class="p-5">
    ...
    <div class="row col-md-12">
        ...
        <div class="col-md-12" style="align-self:center;">
            ...
            <textarea name="product_detail_large" id="product_detail_large" class="form-control" placeholder="รายละเอียดสินค้า" id="" cols="30" rows="10">
                <?php echo str_replace("<br>","\n", $data['product_detail_large'])?>
            </textarea>
        </div>
        <div class="col-md-6" style="align-self:center;">
            ...
            <input 
                type="checkbox" 
                oninput="console.log(this.checked)" 
                <?php 
                    if ($data['promotion']) {
                        echo "checked";
                    } 
